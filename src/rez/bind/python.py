...
def bind(path, version_range=None, opts=None, parser=None):
    ...
    Notes:
        `bleeding-rez` deviates from original `nerdvegas/rez` by still using
        the older, script based Python binding method rather than the newer
        symlinked based binding method.
    """
